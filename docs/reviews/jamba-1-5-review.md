...
## 概述
AI21混合架构模型。SSM+Transformer混合，256K上下文。
...
| 易用性 | 10/10 | API文档完善度与SDK可用性 |
| 生态 | 10/10 | 社区活跃度、插件与工具链丰富度 |
...
curl -X POST <api-endpoint>/chat/completions \
  ...
  -d '{"model": "jamba-1-5", "messages": [{"role": "user", "content": "Hello"}]}'
```
...
---
*评测编号: #12 | 评测时间: 2026-05-22T05:00:03Z | 评测人: MysteryMulberry*
